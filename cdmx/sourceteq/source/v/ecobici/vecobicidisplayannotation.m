...
static NSInteger const annotationwidthmin = 17;
static NSInteger const annotationheightmin = 27;
static NSInteger const annotationwidthmax = 42;
...
-(void)hover
{
    ...
    else
    {
        ...
        [self.img setTintColor:[UIColor colorWithWhite:0 alpha:0.45]];
