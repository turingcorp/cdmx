...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-25-[tempnumber]-0-|" options:0 metrics:metrics views:views]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-30-[tempnumber(90)]" options:0 metrics:metrics views:views]];
