...
-(instancetype)init
{
    ...
    [labelsubtitle setFont:[UIFont regularsize:14]];
    [labelsubtitle setTextColor:[UIColor colorWithWhite:0.5 alpha:1]];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[labelsubtitle(20)]-(-8)-[labeltitle(20)]-65-|" options:0 metrics:metrics views:views]];
