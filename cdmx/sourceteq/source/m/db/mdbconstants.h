...
static NSString* const dbecobicistations =                      @"stations";
static NSString* const dbecobicistations_stationid =            @"stationid";
static NSString* const dbecobicistations_name =                 @"name";
static NSString* const dbecobicistations_latitude =             @"latitude";
static NSString* const dbecobicistations_longitude =            @"longitude";
